        ...
        <div class="hero">
            <div class="with-sidebar">
                ...
                <div class="not-sidebar">
                    ...
                    <br>
                    <br>
                    <span id="github-ind">*Todos os projetos desenvolvidos nesse site possuem os códigos fontes e resultados armazenados no <a href="https://github.com/vinisaurin/RL_Multi-Armed_Bandits_Problem">github <i class="fa fa-github"></i></a>.</span>
                </div>
            </div>
        </div>
        <footer>
